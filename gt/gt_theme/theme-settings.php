...
function gt_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['options']['gt'] = array(
    '#type' => 'details',
    '#attributes' => array(),
    '#title' => t('Georgia Tech theme package'),
  ...
  $form['breadcrumbs']['hide_breadcrumb'] = array(
    '#type' => 'checkbox',
  ...
  $form['fontawesome'] = array(
    ...
    '#description' => t('Configuration options for the Font Awesome library'),
    '#weight' => -996,
    '#group' => 'options',
    '#open' => TRUE,
  );

  $form['fontawesome']['fontawesome_std'] = array(
    '#type' => 'checkbox',
    '#title' => t('Enable Font Awesome'),
    '#default_value' => is_null(theme_get_setting('fontawesome_std')) ? 1 : 0,
    '#description' => t('Uncheck to disable inclusion of the Font Awesome library.'),
    '#options' => array(
     '0' => t('Disable'),
     '1' => t('Enable'),
   ),
